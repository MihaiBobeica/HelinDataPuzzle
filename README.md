...
2. Checking for a word to have 5 different letters can be done by checking if its translation has 5 bits. To do this, we remove the least significant using bit operations
